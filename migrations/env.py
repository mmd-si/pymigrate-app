...
# import local models so they register on LocalBase.metadata
from app.models import local  # noqa: F401
...
# this app only migrates the local database's models; the remote
