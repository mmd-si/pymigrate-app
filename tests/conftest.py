...
os.environ.setdefault('ODOO_USER', 'odoo')
os.environ.setdefault('ODOO_PASSWORD', 'odoo')
os.environ.setdefault('ODOO_TIMEOUT', '30')
os.environ.setdefault('TRANSFER_BATCH_LIMIT', '10')
os.environ.setdefault('TRANSFER_MAX_TRIES', '3')
os.environ.setdefault('TRANSFER_POLL_INTERVAL', '30')
os.environ.setdefault('ODOO_FAKE_BARCODES', 'False')
